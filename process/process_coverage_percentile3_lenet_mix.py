...
# 获取两层之间的每个数据的对应的
def process_three_layer(m, n, k, active_datas1, active_datas2, active_datas3, save_paths, layer_index, type=None):
    # 首先样本数据量需要一致对吧
                ...
                for i in range(len(save_paths)):
                    ...
                    if len(process_data[i]) == batch_size or condition_index == combination_nums:
                        ...
                        np.save(os.path.join(save_path,
                                             'lenet5_coverage_total_layer_index_' + str(layer_index) + '_batch_' + str(
    ...
    for percentile in [75]:
        for type in [0, 1, 2]:
            ...
            for layer_num in range(layer_nums - 2):
                ...
                process_three_layer(m, n, k, datas_1_list, datas_2_list, datas_3_list, save_paths, layer_num, type)
